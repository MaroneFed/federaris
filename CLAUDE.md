...
| Corps subjectif | Le personnage existe en **deux modèles séparés** : `CharacterRig` (vu de dehors : écran-titre, et les autres joueurs en Phase 3) et `FirstPersonBody` (vu par ses propres yeux). Ne jamais tenter de masquer le premier pour en faire le second — on l'a fait quatre fois, il restait toujours une pièce oubliée. Le corps subjectif contient **avant-bras, mains, jambes, pieds. Pas de poncho, pas de bâton** : porté devant ses propres yeux, un poncho forme un anneau qui encercle l'image. Deux règles, vérifiées par le jeu au démarrage **et à chaque image** : rien à moins de 40 cm de l'œil, rien qui couvre plus de 60 % de la hauteur d'écran. |
