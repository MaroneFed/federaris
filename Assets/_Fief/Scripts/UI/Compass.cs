...
namespace Fief
{
    ...
    public static class Compass
    {
        ...
        static void Collect(Vector3 me)
        {
            ...
            Add(Game.CastleCentre, UiStyle.Shape.Square, new Color(0.93f, 0.7f, 0.36f), 9f, "Chateau", false);
            ...
            if (h != null)
            {
                if (h.CampPlanted) Add(h.CampPosition, UiStyle.Shape.Triangle, new Color(0.62f, 0.86f, 0.48f), 12f, "Camp", false);
                ...
                if (h.StelePlanted)
                    Add(h.StelePosition, UiStyle.Shape.Diamond, Stele.RuneBlue, 15f, "Ta stele", h.Trophy != null);
            }
            ...
            for (int i = 0; i < Stele.All.Count; i++)
            {
                ...
                Add(st.transform.position, UiStyle.Shape.Diamond, st.owner.Colour, 12f, "Stele de " + st.owner.Name, false);
            }
